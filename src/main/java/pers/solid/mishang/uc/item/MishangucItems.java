...
public final class MishangucItems {
  ...
  public static final IdCheckerToolItem ID_CHECKER_TOOL =
      new IdCheckerToolItem(new Item.Settings().maxCount(1), null);

  public static final IdCheckerToolItem FLUID_ID_CHECKER_TOOL =
      new IdCheckerToolItem(new Item.Settings().maxCount(1), true);

  public static final FastBuildingToolItem FAST_BUILDING_TOOL =
      new FastBuildingToolItem(new Item.Settings().maxCount(1), null);

  public static final ColumnBuildingTool COLUMN_BUILDING_TOOL = new ColumnBuildingTool(new Item.Settings().maxCount(1), null);

  public static final RotatingToolItem ROTATING_TOOL =
      new RotatingToolItem(new Item.Settings().maxDamage(512), null);

  public static final MirroringToolItem MIRRORING_TOOL =
      new MirroringToolItem(new Item.Settings().maxDamage(512), null);

  public static final SlabToolItem SLAB_TOOL =
      new SlabToolItem(new Item.Settings().maxDamage(1024));

  public static final ForcePlacingToolItem FORCE_PLACING_TOOL =
      new ForcePlacingToolItem(new Item.Settings().maxCount(1), null);

  public static final ForcePlacingToolItem FLUID_FORCE_PLACING_TOOL =
      new ForcePlacingToolItem(new Item.Settings().maxCount(1), true);

  public static final BlockStateToolItem BLOCK_STATE_TOOL =
      new BlockStateToolItem(new Item.Settings().maxCount(1), null);

  public static final BlockStateToolItem FLUID_STATE_TOOL =
      new BlockStateToolItem(new Item.Settings().maxCount(1), true);

  public static final DataTagToolItem DATA_TAG_TOOL =
      new DataTagToolItem(new Item.Settings().maxCount(1), null);

  public static final TextCopyToolItem TEXT_COPY_TOOL = new TextCopyToolItem(new Item.Settings().maxDamage(1024), null);

  public static final OmnipotentToolItem OMNIPOTENT_TOOL = new OmnipotentToolItem(new Item.Settings().fireproof().rarity(Rarity.EPIC).maxCount(1));
  ...
  @ApiStatus.AvailableSince("0.2.4")
  public static final TpToolItem TP_TOOL = new TpToolItem(new Item.Settings().maxDamage(2048));
  @ApiStatus.AvailableSince("0.2.4")
  public static final GrowthToolItem GROWTH_TOOL = new GrowthToolItem(new Item.Settings().maxDamage(1024));
  @ApiStatus.AvailableSince("0.2.4")
  public static final CarryingToolItem CARRYING_TOOL = new CarryingToolItem(new Item.Settings().maxCount(1), null);
  public static final IceSnowTool ICE_SNOW_TOOL = new IceSnowTool(new Item.Settings().maxDamage(128));
