...
public final class MishangucItems {
  ...
  public static final ColumnBuildingTool COLUMN_BUILDING_TOOL = new ColumnBuildingTool(new FabricItemSettings().group(MishangucItemGroups.TOOLS).maxCount(1), null);
  ...
  public static final IceSnowTool ICE_SNOW_TOOL = new IceSnowTool(new FabricItemSettings().group(MishangucItemGroups.TOOLS).maxDamage(128));
