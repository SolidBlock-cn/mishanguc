...
public class MishangucRecipeProvider extends FabricRecipeProvider {
  ...
  private static void addRoadPalingRecipes(RecipeExporter exporter) {
    ...
    StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.fromTag(roadBlocks), RecipeCategory.BUILDING_BLOCKS, RoadBlocks.ROAD_BLOCK)
    ...
    StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.fromTag(roadSlabs), RecipeCategory.BUILDING_BLOCKS, roadSlabBlock)
