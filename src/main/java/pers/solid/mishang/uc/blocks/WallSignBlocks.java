...
public final class WallSignBlocks extends MishangucBlocks {
  ...
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final WallSignBlock NETHERITE_WALL_SIGN = new WallSignBlock(Blocks.NETHERITE_BLOCK, FabricToolTags.PICKAXES, 3);
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final GlowingWallSignBlock GLOWING_NETHERITE_WALL_SIGN = new GlowingWallSignBlock(Blocks.NETHERITE_BLOCK, FabricToolTags.PICKAXES, 3);
  // 黑曜石
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final WallSignBlock OBSIDIAN_WALL_SIGN = new WallSignBlock(Blocks.OBSIDIAN, FabricToolTags.PICKAXES, 3);
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final GlowingWallSignBlock GLOWING_OBSIDIAN_WALL_SIGN = new GlowingWallSignBlock(Blocks.OBSIDIAN, FabricToolTags.PICKAXES, 3);
  // 哭泣的黑曜石
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final WallSignBlock CRYING_OBSIDIAN_WALL_SIGN = new WallSignBlock(Blocks.CRYING_OBSIDIAN, FabricToolTags.PICKAXES, 3);
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.2.4")
  public static final GlowingWallSignBlock GLOWING_CRYING_OBSIDIAN_WALL_SIGN = new GlowingWallSignBlock(Blocks.CRYING_OBSIDIAN, FabricToolTags.PICKAXES, 3);
  // 下界岩
  @RegisterIdentifier
  @ApiStatus.AvailableSince("0.1.7")
