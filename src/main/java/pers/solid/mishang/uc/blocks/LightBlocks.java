...
public final class LightBlocks extends MishangucBlocks {
  ...
  public static final BRRPCubeBlock WHITE_LIGHT = new BRRPCubeBlock(WHITE_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/white_light")));
  ...
  public static final BRRPCubeBlock YELLOW_LIGHT = new BRRPCubeBlock(YELLOW_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/yellow_light")));
  @ApiStatus.AvailableSince("1.1.0")
  ...
  public static final BRRPCubeBlock ORANGE_LIGHT = new BRRPCubeBlock(ORANGE_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/orange_light")));
  ...
  public static final BRRPCubeBlock GREEN_LIGHT = new BRRPCubeBlock(GREEN_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/green_light")));
  ...
  public static final BRRPCubeBlock CYAN_LIGHT = new BRRPCubeBlock(CYAN_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/cyan_light")));
  @ApiStatus.AvailableSince("1.1.0")
  ...
  public static final BRRPCubeBlock PINK_LIGHT = new BRRPCubeBlock(PINK_LIGHT_SETTINGS, new Identifier("mishanguc:block/light"), Texture.all(new Identifier("mishanguc:block/pink_light")));
