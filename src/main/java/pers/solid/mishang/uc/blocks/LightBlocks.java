...
public final class LightBlocks extends MishangucBlocks {
  ...
  public static final BRRPCubeBlock WHITE_LIGHT = new FullLightBlock(WHITE_LIGHT_SETTINGS, new Identifier("mishanguc", "block/white_light"), Items.WHITE_DYE, Items.WHITE_CONCRETE);
  ...
  public static final BRRPCubeBlock YELLOW_LIGHT = new FullLightBlock(YELLOW_LIGHT_SETTINGS, new Identifier("mishanguc", "block/yellow_light"), Items.YELLOW_DYE, Items.YELLOW_CONCRETE);
  @ApiStatus.AvailableSince("1.1.0")
  ...
  public static final BRRPCubeBlock ORANGE_LIGHT = new FullLightBlock(ORANGE_LIGHT_SETTINGS, new Identifier("mishanguc", "block/orange_light"), Items.ORANGE_DYE, Items.ORANGE_CONCRETE);
  ...
  public static final BRRPCubeBlock GREEN_LIGHT = new FullLightBlock(GREEN_LIGHT_SETTINGS, new Identifier("mishanguc", "block/green_light"), Items.LIME_DYE, Items.LIME_CONCRETE);
  ...
  public static final BRRPCubeBlock CYAN_LIGHT = new FullLightBlock(CYAN_LIGHT_SETTINGS, new Identifier("mishanguc", "block/cyan_light"), Items.CYAN_DYE, Items.CYAN_CONCRETE);
  @ApiStatus.AvailableSince("1.1.0")
  ...
  public static final BRRPCubeBlock PINK_LIGHT = new FullLightBlock(PINK_LIGHT_SETTINGS, new Identifier("mishanguc", "block/pink_light"), Items.PINK_DYE, Items.PINK_CONCRETE);
