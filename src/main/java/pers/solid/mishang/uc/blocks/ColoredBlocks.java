...
public final class ColoredBlocks extends MishangucBlocks {
  ...
  public static final ColoredCubeBlock COLORED_STONE = new ColoredCubeBlock(Block.Settings.copy(Blocks.STONE), ColoredCubeBlock.COLORED_CUBE_ALL, TextureMap.all(new Identifier("mishanguc:block/pale_stone"))) {
    @Override
  ...
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_PURE_BLOCK_WITHOUT_SHADE = new ColoredCubeBlock(AbstractBlock.Settings.create().mapColor(DyeColor.WHITE).strength(0.2f), ColoredCubeBlock.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMap.all(new Identifier("mishanguc:block/white_pure")));
  @MiningLevel(MiningLevel.Tool.NONE)
