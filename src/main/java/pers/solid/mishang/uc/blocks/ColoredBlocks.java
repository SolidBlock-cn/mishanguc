...
public final class ColoredBlocks extends MishangucBlocks {
  ...
  public static final ColoredPillarBlock COLORED_QUARTZ_PILLAR = register("colored_quartz_pillar", settings -> new ColoredPillarBlock(settings, TextureMapReference.sideEnd(Identifier.ofVanilla("block/quartz_pillar"), Identifier.ofVanilla("block/quartz_pillar_top"))), Blocks.QUARTZ_PILLAR);
  ...
  public static final ColoredPillarBlock COLORED_PURPUR_PILLAR = register("colored_purpur_pillar", settings -> new ColoredPillarBlock(settings, TextureMapReference.sideEnd(Identifier.of("mishanguc:block/pale_purpur_pillar"), Identifier.of("mishanguc:block/pale_purpur_pillar_top"))), Blocks.PURPUR_PILLAR);
  ...
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_LIGHT = register("colored_light", settings -> new ColoredCubeBlock(settings, ModelReference.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMapReference.all(Identifier.of("mishanguc:block/white_light"))), WHITE_LIGHT_SETTINGS);
  @Translucent
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredGlassBlock COLORED_GLASS = register("colored_glass", settings -> new ColoredGlassBlock(settings, TextureMapReference.all(Identifier.ofVanilla("block/white_stained_glass"))), Blocks.WHITE_STAINED_GLASS);
  @Translucent
  ...
  @Translucent
  public static final ColoredIceBlock COLORED_ICE = register("colored_ice", settings -> new ColoredIceBlock(settings, TextureMapReference.all(Identifier.of("mishanguc:block/pale_ice"))), Blocks.ICE);
  @MiningLevel(MiningLevel.Tool.SHOVEL)
  ...
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_PURE_BLOCK_WITHOUT_SHADE = register("colored_pure_block_without_shade", settings -> new ColoredCubeBlock(settings.mapColor(DyeColor.WHITE).strength(0.2f), ModelReference.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMapReference.all(Identifier.of("mishanguc:block/white_pure"))), COLORED_PURE_BLOCK);
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_PURE_LIGHT_WITHOUT_SHADE = register("colored_pure_light_without_shade", settings -> new ColoredCubeBlock(settings, ModelReference.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMapReference.all(Identifier.of("mishanguc:block/white_pure"))), WHITE_LIGHT_SETTINGS);
