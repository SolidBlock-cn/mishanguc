...
public final class ColoredBlocks extends MishangucBlocks {
  ...
  @Translucent
  public static final ColoredIceBlock COLORED_ICE = new ColoredIceBlock(FabricBlockSettings.copyOf(Blocks.ICE), Texture.all(new Identifier("mishanguc:block/pale_ice")));
