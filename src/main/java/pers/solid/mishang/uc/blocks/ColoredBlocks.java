...
public final class ColoredBlocks extends MishangucBlocks {
  ...
  public static final ColoredPillarBlock COLORED_PURPUR_PILLAR = register("colored_purpur_pillar", settings -> new ColoredPillarBlock(settings, TextureMapReference.sideEnd(Identifier.parse("mishanguc:block/pale_purpur_pillar"), Identifier.parse("mishanguc:block/pale_purpur_pillar_top"))), Blocks.PURPUR_PILLAR);
  ...
  public static final ColoredLeavesBlock COLORED_OAK_LEAVES = register("colored_oak_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createOakLeavesDrops(block, Blocks.OAK_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/oak_leaves"), Blocks.OAK_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_DARK_OAK_LEAVES = register("colored_dark_oak_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createOakLeavesDrops(block, Blocks.DARK_OAK_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/dark_oak_leaves"), Blocks.DARK_OAK_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_PALE_OAK_LEAVES = register("colored_pale_oak_leaves", settings -> new ColoredLeavesBlock(0.02F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createOakLeavesDrops(block, Blocks.PALE_OAK_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/pale_oak_leaves"), Blocks.PALE_OAK_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_BIRCH_LEAVES = register("colored_birch_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createLeavesDrops(block, Blocks.BIRCH_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/birch_leaves"), Blocks.BIRCH_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_ACACIA_LEAVES = register("colored_acacia_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createLeavesDrops(block, Blocks.ACACIA_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/acacia_leaves"), Blocks.ACACIA_LEAVES);
  ...
  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_JUNGLE_LEAVES = register("colored_jungle_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createLeavesDrops(block, Blocks.JUNGLE_SAPLING, 0.025F, 0.027777778F, 0.03125F, 0.041666668F, 0.1F), "block/jungle_leaves"), Blocks.JUNGLE_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_SPRUCE_LEAVES = register("colored_spruce_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (block, blockLootTableGenerator) -> blockLootTableGenerator.createLeavesDrops(block, Blocks.SPRUCE_SAPLING, 0.05F, 0.0625F, 0.083333336F, 0.1F), "block/spruce_leaves"), Blocks.SPRUCE_LEAVES);

  @MiningLevel(MiningLevel.Tool.HOE)
  public static final ColoredLeavesBlock COLORED_MANGROVE_LEAVES = register("colored_mangrove_leaves", settings -> new ColoredLeavesBlock(0.01F, settings, (leaves, blockLootTableGenerator) -> blockLootTableGenerator.createMangroveLeavesDrops(leaves), "block/mangrove_leaves"), Blocks.MANGROVE_LEAVES);
  ...
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_PURE_BLOCK_WITHOUT_SHADE = register("colored_pure_block_without_shade", settings -> new ColoredCubeBlock(settings.mapColor(DyeColor.WHITE).strength(0.2f), ModelReference.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMapReference.all(Identifier.parse("mishanguc:block/white_pure"))), COLORED_PURE_BLOCK);
  @MiningLevel(MiningLevel.Tool.NONE)
  public static final ColoredCubeBlock COLORED_PURE_LIGHT_WITHOUT_SHADE = register("colored_pure_light_without_shade", settings -> new ColoredCubeBlock(settings, ModelReference.COLORED_CUBE_ALL_WITHOUT_SHADE, TextureMapReference.all(Identifier.parse("mishanguc:block/white_pure"))), WHITE_LIGHT_SETTINGS);
