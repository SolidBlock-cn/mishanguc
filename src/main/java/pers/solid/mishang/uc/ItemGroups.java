...
public class ItemGroups {
    ...
    public static final ItemGroup TOOLS = FabricItemGroupBuilder.create(new Identifier("mishanguc","tools")).icon(Suppliers.ofInstance(new ItemStack(MUItems.ROAD_CONNECTION_STATE_DEBUGGING_TOOL))).build();
}
