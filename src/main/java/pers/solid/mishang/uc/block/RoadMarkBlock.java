  ...
  protected static class AxisFacing extends RoadMarkBlock {
    ...
    public BlockState mirror(BlockState state, BlockMirror mirror) {
      ...
      if (RoadMarkBlocks.LEFT_TO_RIGHT.containsKey(this)) {
        mirror1 = MishangUtils.copyPropertiesFrom(RoadMarkBlocks.LEFT_TO_RIGHT.get(this).getDefaultState(), mirror1);
      } else if (RoadMarkBlocks.LEFT_TO_RIGHT.inverse().containsKey(this)) {
        mirror1 = MishangUtils.copyPropertiesFrom(RoadMarkBlocks.LEFT_TO_RIGHT.inverse().get(this).getDefaultState(), mirror1);
      }
