...
public class ColoredGlowingHungSignBlock extends GlowingHungSignBlock implements ColoredBlock {
  public static final MapCodec<ColoredGlowingHungSignBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(baseBlockCodec(), createSettingsCodec()).apply(instance, ColoredGlowingHungSignBlock::new));

  public ColoredGlowingHungSignBlock(@NotNull Block baseBlock, Settings settings) {
