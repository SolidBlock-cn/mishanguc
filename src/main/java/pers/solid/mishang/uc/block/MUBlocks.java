...
public final class MUBlocks {
    ...
    // 普通路块部分。
    @InGroup("roads")
    @RegisterIdentifier("asphalt_road_block")
    public static final RoadBlock ASPHALT_ROAD_BLOCK = new RoadBlock(ASPHALT_ROAD_SETTINGS);
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_straight_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_right_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_bevel_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_straight_and_bevel_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_joint_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_with_white_cross_line")
    ...
    @RegisterIdentifier("asphalt_road_filled_with_white")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_slab_with_white_right_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_slab_with_white_bevel_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_slab_with_white_straight_and_bevel_angle_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_slab_with_white_joint_line")
    ...
    @Cutout
    @RegisterIdentifier("asphalt_road_slab_with_white_cross_line")
    ...
    @RegisterIdentifier("asphalt_road_filled_with_white_slab")
