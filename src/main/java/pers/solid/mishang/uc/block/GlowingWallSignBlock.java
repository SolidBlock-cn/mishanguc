...
public class GlowingWallSignBlock extends WallSignBlock {
   ...
   */
  public @Nullable LogicMaterial glowMaterial = DEFAULT_GLOW_MATERIAL;
  ...
  public void registerModels(ModelProvider modelProvider, BlockModelGenerators blockStateModelGenerator) {
    final TextureMapping textures = TextureMapping.defaultTexture(getBaseMaterial()).put(MishangucTextureKeys.GLOW, glowMaterial.toClientMaterial());
