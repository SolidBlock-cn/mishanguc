...
public class RoadBlock extends AbstractRoadBlock {
  ...
  public ModelJsonBuilder getBlockModel() {
    return ModelJsonBuilder.create(Models.CUBE_ALL).setTextures(Texture.all(new Identifier(texture)));
  }
  ...
  private ModelJsonBuilder getSlabBlockModel() {
    return ModelJsonBuilder.create(Models.SLAB).setTextures(new Texture().put(TextureKey.TOP, new Identifier(texture)).put(TextureKey.BOTTOM, new Identifier(texture)).put(TextureKey.SIDE, new Identifier(texture)));
  }
