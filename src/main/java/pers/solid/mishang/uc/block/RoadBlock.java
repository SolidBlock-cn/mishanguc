...
public class RoadBlock extends AbstractRoadBlock {
  ...
  private ModelJsonBuilder getSlabBlockModel() {
    return ModelJsonBuilder.create(Models.SLAB).setTextures(Texture.topBottom(new Identifier(texture), new Identifier(texture)).put(TextureKey.SIDE, new Identifier(texture)));
  }
