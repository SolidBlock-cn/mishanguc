...
public class WallSignBlock extends WallMountedBlock implements Waterloggable, BlockEntityProvider, BlockResourceGenerator {
  ...
  public ActionResult onUse(
    ...
    if (!player.abilities.allowModifyWorld) {
      ...
      for (BlockEntity value : worldChunk.getBlockEntities().values()) {
        if (value instanceof WallSignBlockEntity) {
          WallSignBlockEntity wallSignBlockEntity = (WallSignBlockEntity) value;
  ...
  public @Nullable RecipeJsonFactory getCraftingRecipe() {
    ...
    return ShapedRecipeJsonFactory.create(this, 6)
        ...
        .criterionFromItem("has_sign", WallSignBlocks.INVISIBLE_WALL_SIGN)::offerTo;
  }
