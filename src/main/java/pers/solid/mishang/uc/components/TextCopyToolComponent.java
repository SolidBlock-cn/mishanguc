...
public record TextCopyToolComponent(boolean fromVanillaSign) {
  ...
  public static final PacketCodec<RegistryByteBuf, TextCopyToolComponent> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.BOOLEAN, TextCopyToolComponent::fromVanillaSign, TextCopyToolComponent::new);
}
