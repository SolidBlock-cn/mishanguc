...
public final class MishangucRules {
  ...
  public static final GameRules.Key<DoubleRule> ROAD_BOOST_SPEED = register("road_boost_speed", GameRuleFactory.createDoubleRule(0, FabricLoader.getInstance().isDevelopmentEnvironment() ? -2 : 0, FabricLoader.getInstance().isDevelopmentEnvironment() ? 50 : 10, (server, rule) -> {
   ...
   */
  @ApiStatus.Internal
  public static double currentRoadBoostSpeed = 0;
  @ApiStatus.Internal
  public static boolean filterRoadBoost = false;
