...
public class Mishanguc implements ModInitializer {
  ...
  private static void registerColoredBlocks() {
    ...
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "concrete_hung_signs")), HungSignBlocks.COLORED_CONCRETE_HUNG_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_concrete_hung_signs")), HungSignBlocks.COLORED_GLOWING_CONCRETE_HUNG_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "concrete_hung_sign_bars")), HungSignBlocks.COLORED_CONCRETE_HUNG_SIGN_BAR);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "terracotta_hung_signs")), HungSignBlocks.COLORED_TERRACOTTA_HUNG_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_terracotta_hung_signs")), HungSignBlocks.COLORED_GLOWING_TERRACOTTA_HUNG_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "terracotta_hung_sign_bars")), HungSignBlocks.COLORED_TERRACOTTA_HUNG_SIGN_BAR);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "concrete_standing_signs")), StandingSignBlocks.COLORED_CONCRETE_STANDING_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "terracotta_standing_signs")), StandingSignBlocks.COLORED_TERRACOTTA_STANDING_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_concrete_standing_signs")), StandingSignBlocks.COLORED_GLOWING_CONCRETE_STANDING_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_terracotta_standing_signs")), StandingSignBlocks.COLORED_GLOWING_TERRACOTTA_STANDING_SIGN);
    ...
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "wooden_wall_signs")), WallSignBlocks.COLORED_WOODEN_WALL_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "concrete_wall_signs")), WallSignBlocks.COLORED_CONCRETE_WALL_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "terracotta_wall_signs")), WallSignBlocks.COLORED_TERRACOTTA_WALL_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_concrete_wall_signs")), WallSignBlocks.COLORED_GLOWING_CONCRETE_WALL_SIGN);
    tagMap.put(TagKey.of(RegistryKeys.BLOCK, Identifier.of("mishanguc", "glowing_terracotta_wall_signs")), WallSignBlocks.COLORED_GLOWING_TERRACOTTA_WALL_SIGN);
