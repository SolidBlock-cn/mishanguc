...
public class MishangucItemGroups {
  ...
  public static final ItemGroup SIGNS = Registry.register(Registries.ITEM_GROUP, Mishanguc.id("signs"),
  ...
  public static final ItemGroup TOOLS = Registry.register(Registries.ITEM_GROUP, Mishanguc.id("tools"),
  ...
  public static final ItemGroup DECORATIONS = Registry.register(Registries.ITEM_GROUP, Mishanguc.id("decorations"), FabricItemGroup.builder().icon(() -> new ItemStack(HandrailBlocks.SIMPLE_ORANGE_CONCRETE_HANDRAIL)).entries((displayContext, entries) -> MishangUtils.instanceStream(HandrailBlocks.class, Block.class).forEach(addEntries(entries))).displayName(Text.translatable("itemGroup.mishanguc.decorations")).build());

  public static final ItemGroup COLORED_BLOCKS = Registry.register(Registries.ITEM_GROUP, Mishanguc.id("colored_blocks"), FabricItemGroup.builder().icon(() -> new ItemStack(ColoredBlocks.COLORED_WOOL)).entries((displayContext, entries) -> MishangUtils.instanceStream(ColoredBlocks.class, Block.class).forEach(addEntries(entries))).displayName(Text.translatable("itemGroup.mishanguc.colored_blocks")).build());
