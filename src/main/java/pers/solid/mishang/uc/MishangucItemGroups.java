...
public class MishangucItemGroups {
  ...
  public static final ItemGroup LIGHTS =
      FabricItemGroup.builder(
          new Identifier("mishanguc", "lights")).icon(() -> new ItemStack(LightBlocks.WHITE_LARGE_WALL_LIGHT)).entries((enabledFeatures, entries, operatorEnabled) -> MishangUtils.instanceStream(LightBlocks.class, Block.class).forEach(addEntries(entries))).build();
  ...
  public static final ItemGroup TOOLS =
      FabricItemGroup.builder(new Identifier("mishanguc", "tools")).icon(() -> new ItemStack(MishangucItems.ROTATING_TOOL)).entries((enabledFeatures, entries, operatorEnabled) -> MishangUtils.instanceStream(MishangucItems.class, ItemConvertible.class).forEach(item -> {
  ...
  public static final ItemGroup DECORATIONS = FabricItemGroup.builder(new Identifier("mishanguc", "decorations")).icon(() -> new ItemStack(HandrailBlocks.SIMPLE_ORANGE_CONCRETE_HANDRAIL)).entries((enabledFeatures, entries, operatorEnabled) -> MishangUtils.instanceStream(HandrailBlocks.class, Block.class).forEach(addEntries(entries))).build();

  public static final ItemGroup COLORED_BLOCKS = FabricItemGroup.builder(new Identifier("mishanguc", "colored_blocks")).icon(() -> new ItemStack(ColoredBlocks.COLORED_WOOL)).entries((enabledFeatures, entries, operatorEnabled) -> MishangUtils.instanceStream(ColoredBlocks.class, Block.class).forEach(addEntries(entries))).build();
