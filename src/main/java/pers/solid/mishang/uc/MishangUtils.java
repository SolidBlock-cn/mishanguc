...
public class MishangUtils {
  ...
  public static int readColorFromNbtElement(NbtElement nbtColor) {
    if (nbtColor instanceof AbstractNbtNumber) {
      AbstractNbtNumber abstractNbtNumber = (AbstractNbtNumber) nbtColor;
    ...
    } else if (nbtColor instanceof AbstractNbtList<?>) {
      AbstractNbtList<?> list = (AbstractNbtList<?>) nbtColor;
    ...
    } else if (nbtColor instanceof NbtCompound) {
      NbtCompound nbtCompound = (NbtCompound) nbtColor;
