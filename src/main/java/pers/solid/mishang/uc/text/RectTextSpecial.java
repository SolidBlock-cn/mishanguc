...
public class RectTextSpecial implements TextSpecial {
  ...
  public void drawExtra(TextRenderer textRenderer, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light, float x, float y) {
    ...
    glyphRenderer.drawRectangle(rectangle, matrixStack.peek().getPositionMatrix(), vertexConsumers.getBuffer(glyphRenderer.getLayer(textContext.seeThrough ? TextRenderer.TextLayerType.SEE_THROUGH : TextRenderer.TextLayerType.NORMAL)), light);
  }
